...
-- idx_invoices_one_rechnung_per_repair und idx_invoices_repair_kind
-- werden in migrateInvoicesGobd() erstellt (nach ALTER TABLE, falls document_kind noch fehlt).
